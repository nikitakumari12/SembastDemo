...
class BookEditScreen extends StatefulWidget {
  static const String screenId = '/book_edit_screen';
...
class _BookEditScreenState extends State<BookEditScreen> {
  ...
  void initState() {
    Library activeBook =
        Provider.of<BookDAO>(context, listen: false).getActiveContact;

    print("Active book Name: " + activeBook.bookname.toString());

    _authorController.text = activeBook.authorname ?? '';
    _nameController.text = activeBook.bookname ?? '';
    _copiesController.text = activeBook.bookCopies ?? '';
    super.initState();
  }
